...
export default function CategoryPage() {
  ...
  const products = [
    {
      id: 1,
      title: "Featured Packing & Jointing",
      category: "Premium",
    ...
    {
      id: 2,
      title: "Standard Packing & Jointing",
      category: "Standard",
      ...
      <section className="bg-blue-600 text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Packing & Jointing</h1>
            <p className="text-xl text-blue-100 leading-relaxed">
              Explore our comprehensive range of packing & jointing tailored for maritime and industrial needs.
            </p>
          </div>
        </div>
      </section>
